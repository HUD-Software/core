...
namespace hud {
    ...
    struct is_nothrow_copy_constructible
        : is_nothrow_constructible<type_t, add_lvalue_reference_t<add_const_t<u_type_t>>> {
    };

    /** Equivalent of is_nothrow_copy_constructible<type_t,u_type_t>::value. */
    template <typename type_t, typename u_type_t = type_t>
    inline constexpr bool is_nothrow_copy_constructible_v = is_nothrow_copy_constructible<type_t, u_type_t>::value;
