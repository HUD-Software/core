...
namespace hud {
    ...
    struct is_comparable_with_equal<lhs_t, rhs_t, void_t<decltype(hud::declval<add_const_t<add_lvalue_reference_t<lhs_t>>>() == hud::declval<add_const_t<add_lvalue_reference_t<rhs_t>>>())>>
        : hud::true_type {
    };
