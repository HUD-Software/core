...
namespace hud {
    ...
    struct conjunction<type_t, rest_t...>
        : conditional_t<type_t::value, conjunction<rest_t...>, type_t> {
        // If type_t is true evaluate next, else type_t is false
    };


    /** Equivalent of conjunction<type_t...>::value. */
    template<typename... type_t>
    inline constexpr bool conjunction_v = conjunction<type_t...>::value;
