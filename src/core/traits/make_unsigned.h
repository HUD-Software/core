...
namespace hud {
    ...
    */
    ...
    struct make_unsigned
        ...
        static_assert(or_v< conjunction<is_integral<type_t>, negation<is_bool<type_t>>>, is_enum<type_t> >, "make_unsigned<type_t> requires that type_t shall be a (possibly cv-qualified) integral type or enumeration but not a bool type.");
    };
