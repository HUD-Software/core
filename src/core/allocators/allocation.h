    ...
    */
    ...
    public:
        ...
        */
        ...
        [[nodiscard]]
        HD_FORCEINLINE constexpr type_t* data() const noexcept {
            return begin_ptr;
        }

        /** Retrieves a pointer to the end of the sequence. */
        [[nodiscard]]
        HD_FORCEINLINE constexpr type_t* data_end() const noexcept {
            return end_ptr;
        }
        ...
        */
        [[nodiscard]]
        HD_FORCEINLINE constexpr slice<type_t> sub_slice(const usize first_index, const usize count) const noexcept {
            check(first_index < this->count()); // "sub_slice can't start after the end of the slice"
            check(first_index + count <= this->count()); // "sub_slice can't end after the end of the slice"
        ...
        [[nodiscard]]
        HD_FORCEINLINE constexpr slice<type_t> to_slice() const noexcept {
