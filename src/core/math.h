...
namespace hud {
    struct Math {
        ...
        */
        ...
        [[nodiscard]]
        static constexpr bool is_power_of_two(const type_t value) noexcept requires(is_integral_v<type_t>)
        {
        ...
        */
        template<typename type_t>
        [[nodiscard]]
        static constexpr bool is_in_range_inclusive(const type_t value, const type_t min, const type_t max) noexcept {
