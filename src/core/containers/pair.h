...
namespace hud {
    ...
    struct pair {
        ...
        */
        constexpr explicit(!(hud::is_implicitly_default_constructible_v<first_type>&& hud::is_implicitly_default_constructible_v<second_type>))
            pair() noexcept requires(hud::is_default_constructible_v<first_type>&& hud::is_default_constructible_v<second_type>)
            : first()
            , second() {
        ...
        */
        constexpr explicit(!(hud::is_convertible_v<const first_type&, first_type>&& hud::is_convertible_v<const second_type&, second_type>))
            pair(const first_type& f, const second_type& s) noexcept requires(hud::is_copy_constructible_v<first_type>&& hud::is_copy_constructible_v<second_type>)
            : first(f)
            , second(s) {
        ...
        */
        ...
        constexpr explicit(!(hud::is_convertible_v<u_type_t&&, first_type>&& hud::is_convertible_v<v_type_t&&, second_type>))
            pair(u_type_t&& f, v_type_t&& s) noexcept requires(hud::is_move_constructible_v<first_type, u_type_t>&& hud::is_move_constructible_v<second_type, v_type_t>)
        ...
        */
        ...
        constexpr explicit(!(hud::is_convertible_v<const u_type1_t&, first_type>&& hud::is_convertible_v<const u_type2_t&, second_type>))
            pair(const pair<u_type1_t, u_type2_t>& other) noexcept requires(hud::is_copy_constructible_v<first_type, u_type1_t>&& hud::is_copy_constructible_v<second_type, u_type2_t>)
            : first(other.first)
            , second(other.second) {
        ...
        */
        ...
        constexpr explicit(!(hud::is_convertible_v<u_type1_t, first_type>&& hud::is_convertible_v<u_type2_t,second_type>))
            pair(pair<u_type1_t, u_type2_t>&& other) noexcept requires(hud::is_move_constructible_v<first_type, u_type1_t>&& hud::is_move_constructible_v<second_type, u_type2_t>)
        ...
        * @return *this
        */
        constexpr pair& operator=(const pair& other) noexcept requires(hud::is_copy_assignable_v<first_type>&& hud::is_copy_assignable_v<second_type>) {
        ...
        */
        ...
        constexpr pair& operator=(const pair<u_type_t, v_type_t>& other) noexcept requires(hud::is_assignable_v<first_type&, const u_type_t&>&& hud::is_copy_assignable_v<second_type, v_type_t>) {
        ...
        * @return *this
        */
        constexpr pair& operator=(pair&& other) noexcept requires(hud::is_move_assignable_v<first_type>&& hud::is_move_assignable_v<second_type>) {
        ...
        */
        template<typename u_type_t, typename v_type_t>
        constexpr pair& operator=(pair<u_type_t, v_type_t>&& other) noexcept requires(hud::is_assignable_v<first_type&, u_type_t&&> && hud::is_assignable_v<second_type&, v_type_t&&>) {
        ...
        */
        constexpr void swap(pair& other) noexcept requires(hud::is_swappable_v<first_type> && hud::is_swappable_v<second_type>) {
    ...
    */
    ...
    static constexpr void swap(pair<first_type, second_type>& a, pair<first_type, second_type>& b) noexcept requires(hud::is_swappable_v<first_type>&& hud::is_swappable_v<second_type>) {
        a.swap(b);
    }
    ...
    */
    template<typename first_type, typename second_type>
    [[nodiscard]]
    constexpr bool operator==(const pair<first_type, second_type>& left, const pair<first_type, second_type>& right) noexcept {
    ...
    */
    template<typename first_type, typename second_type>
    [[nodiscard]]
    constexpr hud::pair<hud::decay_t<first_type>, hud::decay_t<second_type>> make_pair(first_type&& value_1, second_type&& value_2) noexcept {
    ...
    */
    ...
    [[nodiscard]]
    constexpr hud::tuple_element_t<element_index, pair<first_type, second_type>>& get(pair<first_type, second_type>& pair) noexcept {
    ...
    */
    template<usize element_index, typename first_type, typename second_type>
    [[nodiscard]]
    constexpr const hud::tuple_element_t<element_index, const pair<first_type, second_type>>& get(const pair<first_type, second_type>& pair) noexcept {
        static_assert(element_index < 2, "pair index out of bounds");
        if constexpr (element_index == 0) {
            return pair.first;
        }
    ...
    */
    template<usize element_index, typename first_type, typename second_type>
    [[nodiscard]]
    constexpr const hud::tuple_element_t<element_index, pair<first_type, second_type>>&& get(const pair<first_type, second_type>&& pair) noexcept {
        static_assert(element_index < 2, "pair index out of bounds");
        if constexpr (element_index == 0) {
