...
namespace hud {
    ...
    template<typename type1_t, type1_t... seq_1, 
             typename type2_t, type2_t... seq_2, 
             typename... rest_t>
    struct car_index_sequence<integer_sequence<type1_t, seq_1...>, integer_sequence<type2_t, seq_2...>, rest_t...> { // Concatenate 2 integer_sequence with the followings
    ...
    template<typename type_t, type_t... ints>
    struct car_index_sequence<integer_sequence<type_t, ints...>> { // Concatenate 1 integer_sequence
        using value_type = integer_sequence<type_t, ints...>;
    };
    template<typename type_t, type_t... seq_1, type_t... seq_2>
    struct car_index_sequence<integer_sequence<type_t, seq_1...>, integer_sequence<type_t, seq_2...>> { // Concantenante 2 integer_sequence with same type
        using value_type = integer_sequence<type_t, seq_1..., seq_2...>;
    };
    template<typename type1_t, type1_t... seq_1, 
             typename type2_t, type2_t... seq_2>
    struct car_index_sequence<integer_sequence<type1_t, seq_1...>, integer_sequence<type2_t, seq_2...>> {  // Concantenante 2 integer_sequence with different types
