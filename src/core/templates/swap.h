...
namespace hud {
    ...
    static constexpr void swap(type_t& a, u_type_t& b) noexcept requires(hud::is_move_constructible_v<type_t, u_type_t>&& hud::is_move_assignable_v<u_type_t, type_t>) {
    ...
    static constexpr void swap(type_t(&a)[N], type_t(&b)[N]) noexcept requires( hud::is_default_constructible_v<type_t> && hud::is_move_constructible_v<type_t>&& hud::is_move_assignable_v<type_t>) {
