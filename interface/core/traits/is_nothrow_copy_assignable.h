...
namespace hud
{
    ...
    struct is_nothrow_copy_assignable
        : is_nothrow_assignable<hud::add_lvalue_reference_t<type_t>, hud::add_lvalue_reference_t<hud::add_const_t<u_type_t>>>
    {
    };

    /** Equivalent of IsNothrowCopyAssignable<type_t, u_type_t = type_t>::value. */
    template<typename type_t, typename u_type_t = type_t>
    constexpr bool is_nothrow_copy_assignable_v = is_nothrow_copy_assignable<type_t, u_type_t>::value;
