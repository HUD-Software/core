...
GTEST_TEST(i128, constructor_u8)
{
    ...
    // Init to min value
    {
        hud::i128 v {hud::u8_min};
        hud_assert_eq(v, hud::u8_min);
    }

    // Init to max value
    {
        hud::i128 v {hud::u8_max};
...
GTEST_TEST(i128, constructor_u16)
{
    ...
    // Init to min value
    {
        hud::i128 v {hud::u16_min};
        hud_assert_eq(v, hud::u16_min);
    }

    // Init to max value
    {
        hud::i128 v {hud::u16_max};
...
GTEST_TEST(i128, constructor_u32)
{
    ...
    // Init to min value
    {
        hud::i128 v {hud::u32_min};
        hud_assert_eq(v, hud::u32_min);
    }

    // Init to max value
    {
        hud::i128 v {hud::u32_max};
...
GTEST_TEST(i128, constructor_u64)
{
    ...
    // Init to min value
    {
        hud::i128 v {hud::u64_min};
        hud_assert_eq(v, hud::u64_min);
    }

    // Init to max value
    {
        hud::i128 v {hud::u64_max};
...
GTEST_TEST(i128, constructor_high_low)
{
    ...
    {
        hud::i128 v {hud::i64_max, 0};
        hud_assert_eq(v.high(), hud::i64_max);
        hud_assert_eq(v.low(), 0);
    }

    {
        hud::i128 v {0, hud::u64_max};
        hud_assert_eq(v.high(), 0);
...
GTEST_TEST(i128, constructor_unsigned__int128)
{
    // Init to 0
    {
        hud::i128 v {(unsigned __int128) {0}};
        hud_assert_eq(v, hud::i128 {0});
    }
