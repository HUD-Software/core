...
GTEST_TEST(weak_pointer_array_safe, swap_with_empty)
{
    // weak_pointer::swap
    {
        const auto test = []()
        {
            ...
            hud::weak_pointer<hud_test::non_bitwise_type[2], hud::thread_safety_e::safe> empty;
...
GTEST_TEST(weak_pointer_array_safe, swap_same_type)
{
    // weak_pointer::swap
    {
        const auto test = []()
        {
            ...
            hud::shared_pointer<hud_test::non_bitwise_type[2], hud::thread_safety_e::safe> shared_ptr_2(ptr2); // +1 shared_count
