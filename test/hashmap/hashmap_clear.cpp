...
GTEST_TEST(hashmap, clear_then_add_trivially_destructible_empty_map)
{
...
GTEST_TEST(hashmap, clear_then_add_trivially_destructible_non_empty_map)
{
    // No reserve
    {
        const auto test = []()
...
GTEST_TEST(hashmap, clear_then_add_non_trivially_destructible_empty_map)
{
...
GTEST_TEST(hashmap, clear_then_add_non_trivially_destructible_non_empty_map)
{
