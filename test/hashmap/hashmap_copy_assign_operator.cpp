...
GTEST_TEST(hashmap, copy_assign_hashmap_of_bitwise_copy_assignable_same_type_same_allocator)
{
    using key_type = i32;
...
GTEST_TEST(hashmap, copy_assign_hashmap_of_bitwise_copy_assignable_same_type_different_allocator)
{
    using key_type = i32;
    using value_type = u64;
...
GTEST_TEST(hashmap, copy_assign_hashmap_of_bitwise_copy_assignable_different_type_same_allocator)
{
    using key_type = i32;
    using value_type = u64;
...
GTEST_TEST(hashmap, copy_assign_hashmap_of_bitwise_copy_assignable_different_type_different_allocator)
{
    using key_type = i32;
    using value_type = u64;
    using key_type_2 = i128;
