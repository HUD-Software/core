...
{
    hud::hashmap<i32, i64, hud::hash_64<i32>, hud::equal<i32>, hud_test::allocator_watcher<1>> map;
...
GTEST_TEST(hashmap, construct_with_initializer_list_of_non_bitwise_move_constructible_same_type)
{
