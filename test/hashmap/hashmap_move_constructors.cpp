...
GTEST_TEST(hashmap, move_construct_bitwise_copy_constructible_same_type_same_allocator)
{
    ...
    using MovedType = hud::hashmap<key_type, value_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType>;
...
GTEST_TEST(hashmap, move_construct_bitwise_copy_constructible_same_type_different_allocator)
{
    ...
    using NewType = hud::hashmap<key_type, value_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType>;
    using MovedType = hud::hashmap<key_type, value_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType2>;
