...
GTEST_TEST(hashmap, move_assign_hashmap_of_bitwise_move_constructible_same_type_same_allocator)
{
    using key_type = i32;
...
GTEST_TEST(hashmap, move_assign_hashmap_of_bitwise_move_constructible_same_type_different_allocator)
{
    using key_type = i32;
    using value_type = u64;
...
GTEST_TEST(hashmap, move_assign_hashmap_of_bitwise_move_constructible_different_type_same_allocator)
{
    using key_type = i32;
    using value_type = u64;
    ...
    static_assert(hud::is_bitwise_move_constructible_v<value_type_2>);
...
GTEST_TEST(hashmap, move_assign_hashmap_of_bitwise_move_constructible_different_type_different_allocator)
{
    using key_type = i32;
    using value_type = u64;
    using key_type_2 = i128;
...
GTEST_TEST(hashmap, move_assign_hashmap_of_non_bitwise_move_constructible_same_type_same_allocator)
{
    ...
    // Test without extra
    {
        static const auto test = [](std::initializer_list<hud::pair<key_type, value_type>> elements_in_assigned, std::initializer_list<hud::pair<key_type, value_type>> elements_to_assign) {
            ...
            for (usize index = 0; index < elements_to_assign.size(); index++) {
                ...
                if (it->value().copy_constructor_count() != 1) {
                    all_keys_and_values_copied = false;
                    break;
                }
                if (it->value().move_constructor_count() != 1) {
                    all_keys_and_values_copied = false;
                    break;
                }
            }
...
GTEST_TEST(hashmap, move_assign_hashmap_of_non_bitwise_move_constructible_same_type_different_allocator)
{
    using key_type = hud_test::non_bitwise_move_constructible_type;
    using value_type = hud_test::non_bitwise_move_constructible_type2;
...
GTEST_TEST(hashmap, move_assign_hashmap_of_non_bitwise_move_constructible_different_type_same_allocator)
{
    using key_type = hud_test::non_bitwise_move_constructible_type;
    using value_type = hud_test::non_bitwise_move_constructible_type2;
    using key_type_2 = hud_test::non_bitwise_move_constructible_type3;
    using value_type_2 = hud_test::non_bitwise_move_constructible_type4;
...
GTEST_TEST(hashmap, move_assign_hashmap_of_non_bitwise_move_constructible_different_type_different_allocator)
{
    using key_type = hud_test::non_bitwise_move_constructible_type;
    using value_type = hud_test::non_bitwise_move_constructible_type2;
    using key_type_2 = hud_test::non_bitwise_move_constructible_type3;
...
GTEST_TEST(hashmap, move_assign_hashmap_same_allocator_call_destructor_of_elements)
{
...
GTEST_TEST(hashmap, move_assign_hashmap_different_allocator_call_destructor_of_elements)
{
    using key_type = hud_test::SetBoolToTrueWhenDestroyed;
    using value_type = hud_test::SetBoolToTrueWhenDestroyed;
...
GTEST_TEST(array, move_assign_hashmap_of_bitwise_move_assignable_to_self)
{
    using key_type = i32;
    using value_type = u64;
    ...
    // Test without extra
    {
        ...
        {
            {
                constexpr auto result = test(std::initializer_list<hud::pair<key_type, value_type>> {});
                hud_assert_true(std::get<0>(result));
                hud_assert_true(std::get<1>(result));
                hud_assert_true(std::get<2>(result));
            }
...
GTEST_TEST(array, move_assign_hashmap_of_non_bitwise_move_assignable_to_self)
{
