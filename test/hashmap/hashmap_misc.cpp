...
TEST_CASE("hud::hashmap", "[hashmap][misc]")
{
    SECTION("hud::hashmap::value_type is correct")
    {
        REQUIRE((hud::is_same_v<i64, hud::hashmap<i64, i32>::key_type>));
        REQUIRE((hud::is_same_v<i32, hud::hashmap<i64, i32>::value_type>));

        REQUIRE((hud::is_same_v<const i64, hud::hashmap<const i64, i32>::key_type>));
        REQUIRE((hud::is_same_v<const i32, hud::hashmap<i64, const i32>::value_type>));
    }
}
