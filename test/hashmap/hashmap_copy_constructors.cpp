...
GTEST_TEST(hashmap, copy_construct_bitwise_copy_constructible_same_type_same_allocator)
{
    ...
    using CopiedType = hud::hashmap<key_type, value_type, hud::hashmap_default_hasher, hud::hashmap_default_key_equal<key_type>, AllocatorType>;
...
GTEST_TEST(hashmap, copy_construct_bitwise_copy_constructible_same_type_different_allocator)
{
    ...
    using NewType = hud::hashmap<key_type, value_type, hud::hashmap_default_hasher, hud::hashmap_default_key_equal<key_type>, AllocatorType>;
    using CopiedType = hud::hashmap<key_type, value_type, hud::hashmap_default_hasher, hud::hashmap_default_key_equal<key_type>, AllocatorType2>;
    static_assert(hud::is_bitwise_copy_constructible_v<CopiedType::storage_type>);
