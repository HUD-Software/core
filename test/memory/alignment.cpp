...
GTEST_TEST(memory, align_pointer)
{
    ...
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(aligned_pointer, 1));
    GTEST_ASSERT_EQ(*reinterpret_cast<uptr *>((uptr)aligned_pointer - sizeof(usize)), (uptr)buffer_allocated);
    GTEST_ASSERT_EQ(*reinterpret_cast<usize *>((uptr)aligned_pointer - sizeof(usize) - sizeof(void *)), buffer_size);

    aligned_pointer = hud::memory::align_pointer(buffer_allocated, buffer_size, 2);
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(aligned_pointer, 2));
    GTEST_ASSERT_EQ(*reinterpret_cast<uptr *>((uptr)aligned_pointer - sizeof(usize)), (uptr)buffer_allocated);
    GTEST_ASSERT_EQ(*reinterpret_cast<usize *>((uptr)aligned_pointer - sizeof(usize) - sizeof(void *)), buffer_size);

    aligned_pointer = hud::memory::align_pointer(buffer_allocated, buffer_size, 4);
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(aligned_pointer, 4));
    GTEST_ASSERT_EQ(*reinterpret_cast<uptr *>((uptr)aligned_pointer - sizeof(usize)), (uptr)buffer_allocated);
    GTEST_ASSERT_EQ(*reinterpret_cast<usize *>((uptr)aligned_pointer - sizeof(usize) - sizeof(void *)), buffer_size);

    aligned_pointer = hud::memory::align_pointer(buffer_allocated, buffer_size, 8);
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(aligned_pointer, 8));
    GTEST_ASSERT_EQ(*reinterpret_cast<uptr *>((uptr)aligned_pointer - sizeof(usize)), (uptr)buffer_allocated);
    GTEST_ASSERT_EQ(*reinterpret_cast<usize *>((uptr)aligned_pointer - sizeof(usize) - sizeof(void *)), buffer_size);

    aligned_pointer = hud::memory::align_pointer(buffer_allocated, buffer_size, 0xC);
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(aligned_pointer, 0xC));
    GTEST_ASSERT_EQ(*reinterpret_cast<uptr *>((uptr)aligned_pointer - sizeof(usize)), (uptr)buffer_allocated);
    GTEST_ASSERT_EQ(*reinterpret_cast<usize *>((uptr)aligned_pointer - sizeof(usize) - sizeof(void *)), buffer_size);

    aligned_pointer = hud::memory::align_pointer(buffer_allocated, buffer_size, 0x10);
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(aligned_pointer, 0x10));
    GTEST_ASSERT_EQ(*reinterpret_cast<uptr *>((uptr)aligned_pointer - sizeof(usize)), (uptr)buffer_allocated);
    GTEST_ASSERT_EQ(*reinterpret_cast<usize *>((uptr)aligned_pointer - sizeof(usize) - sizeof(void *)), buffer_size);
}
...
GTEST_TEST(memory, is_pointer_aligned)
{
    ...
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000001), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000002), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000003), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000004), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000005), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000006), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000007), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000008), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000009), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000A), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000B), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000C), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000D), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000E), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000F), 1));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000010), 1));

    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000001), 4));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000002), 4));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000003), 4));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000004), 4));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000005), 4));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000006), 4));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000007), 4));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000008), 4));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000009), 4));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000A), 4));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000B), 4));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000C), 4));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000D), 4));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000E), 4));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000F), 4));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000010), 4));

    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000001), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000002), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000003), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000004), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000005), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000006), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000007), 8));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000008), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000009), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000A), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000B), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000C), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000D), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000E), 8));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000F), 8));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000010), 8));

    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000001), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000002), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000003), 0xC));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000004), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000005), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000006), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000007), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000008), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000009), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000A), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000B), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000C), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000D), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000E), 0xC));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000F), 0xC));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000010), 0xC));

    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000001), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000002), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000003), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000004), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000005), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000006), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000007), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000008), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000009), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000A), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000B), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000C), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000D), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000E), 0x10));
    GTEST_ASSERT_FALSE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x0000000F), 0x10));
    GTEST_ASSERT_TRUE(hud::memory::is_pointer_aligned(reinterpret_cast<void *>(0x00000010), 0x10));
}
