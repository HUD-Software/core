...
// array &operator=(std::initializer_list<u_type_t>)
...
GTEST_TEST(array, assign_std_initializer_list_of_bitwise_copy_assignable_different_type)
{
    ...
    // Test with extra
    {
        ...
        {
            hud::array<destination_type, hud_test::allocator_watcher<alignof(destination_type)>> assigned(elements_in_assigned, extra);
...
GTEST_TEST(array, assign_std_initializer_list_call_destructor_of_elements)
{
    ...
    // Test with extra
    {
        const auto test = [](const usize count_in_assigned, const usize extra, const usize count_to_assigned)
        {
            ...
            hud::array<hud_test::SetBoolToTrueWhenDestroyed, hud_test::allocator_watcher<alignof(hud_test::SetBoolToTrueWhenDestroyed)>> assigned(dtor_assigned_ptr_counter, count_in_assigned, extra);
...
GTEST_TEST(array, assign_std_initializer_list_of_bitwise_copy_assignable_same_type_no_extra)
{
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(array, assign_std_initializer_list_of_bitwise_copy_assignable_same_type_with_extra)
{
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(array, assign_std_initializer_list_of_bitwise_copy_assignable_different_type_no_extra)
{
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(array, assign_std_initializer_list_of_bitwise_copy_assignable_different_type_with_extra)
{
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(array, assign_std_initializer_list_of_non_bitwise_copy_assignable_same_type_no_extra)
{
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(array, assign_std_initializer_list_of_non_bitwise_copy_assignable_same_type_with_extra)
{
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(array, assign_std_initializer_list_of_non_bitwise_copy_assignable_different_type_no_extra)
{
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(array, assign_std_initializer_list_of_non_bitwise_copy_assignable_different_type_with_extra)
{
