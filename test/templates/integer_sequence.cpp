...
GTEST_TEST(templates, integer_sequence)
{
    ...
    GTEST_ASSERT_TRUE(seq1_same_type);
    GTEST_ASSERT_EQ(seq1.size(), 2u);
    ...
    GTEST_ASSERT_TRUE(seq2_same_type);
    GTEST_ASSERT_EQ(seq2.size(), 5u);
    ...
    GTEST_ASSERT_TRUE(seq3_same_type);
    GTEST_ASSERT_EQ(seq3.size(), 8u);
    ...
    GTEST_ASSERT_TRUE(seq4_same_type);
    GTEST_ASSERT_EQ(seq4.size(), 9u);
}