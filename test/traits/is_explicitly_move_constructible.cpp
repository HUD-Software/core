...
TEST(traits, is_explicitly_move_constructible) {
    ASSERT_TRUE((hud::is_explicitly_move_constructible_v<explicit_ctor>));
    ASSERT_FALSE((hud::is_explicitly_move_constructible_v<no_explicit_ctor>));
