...
GTEST_TEST(traits, is_bitwise_move_constructible)
{
    ...
    hud_assert_true((hud::is_bitwise_move_constructible_v<i8, char8>));
    ...
    hud_assert_true((hud::is_bitwise_move_constructible_v<u8, char8>));
    ...
    hud_assert_false((hud::is_bitwise_move_constructible_v<i16, char8>));
    ...
    hud_assert_false((hud::is_bitwise_move_constructible_v<u16, char8>));
#if defined(HD_HOST_WINDOWS)
    ...
    hud_assert_false((hud::is_bitwise_move_constructible_v<i32, char8>));
#if defined(HD_HOST_WINDOWS)
    ...
    hud_assert_false((hud::is_bitwise_move_constructible_v<u32, char8>));
#if defined(HD_HOST_WINDOWS)
    ...
    hud_assert_false((hud::is_bitwise_move_constructible_v<i64, char8>));
    ...
    hud_assert_false((hud::is_bitwise_move_constructible_v<u64, char8>));
    ...
    // char8
    hud_assert_true((hud::is_bitwise_move_constructible_v<char8, i8>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, i16>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, i32>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, i64>));
    hud_assert_true((hud::is_bitwise_move_constructible_v<char8, u8>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, u16>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, u32>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, u64>));
    hud_assert_true((hud::is_bitwise_move_constructible_v<char8, char8>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, wchar>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, char16>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, char32>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, f32>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, f64>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, iptr>));
    hud_assert_false((hud::is_bitwise_move_constructible_v<char8, uptr>));
    ...
    hud_assert_false((hud::is_bitwise_move_constructible_v<wchar, char8>));
    ...
    hud_assert_false((hud::is_bitwise_move_constructible_v<char16, char8>));
#if defined(HD_HOST_WINDOWS)
    ...
    hud_assert_false((hud::is_bitwise_move_constructible_v<char32, char8>));
#if defined(HD_HOST_WINDOWS)
    ...
    hud_assert_false((hud::is_bitwise_move_constructible_v<f32, char8>));
    ...
    hud_assert_false((hud::is_bitwise_move_constructible_v<f64, char8>));
...
#endif
    hud_assert_false((hud::is_bitwise_move_constructible_v<iptr, char8>));
    if (sizeof(wchar) == sizeof(iptr)) {
...
#endif
    hud_assert_false((hud::is_bitwise_move_constructible_v<uptr, char8>));
    if (sizeof(wchar) == sizeof(uptr)) {
