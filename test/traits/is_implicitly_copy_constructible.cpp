...
GTEST_TEST(traits, is_implicitly_copy_constructible)
{
    ...
    hud_assert_true((hud::is_implicitly_copy_constructible_v<hud_test::no_explicit_ctor_2>));
    hud_assert_true((hud::is_implicitly_copy_constructible_v<hud_test::no_explicit_ctor_3>));

    // Explicit copy constructor same type
    hud_assert_false((hud::is_implicitly_copy_constructible_v<hud_test::explicit_ctor>));
    hud_assert_false((hud::is_implicitly_copy_constructible_v<hud_test::explicit_ctor_2>));
    hud_assert_false((hud::is_implicitly_copy_constructible_v<hud_test::explicit_ctor_3>));

    // Implicit copy constructor other explicit copy ctor type
    hud_assert_true((hud::is_implicitly_copy_constructible_v<hud_test::no_explicit_cross_explicit_ctor, hud_test::explicit_ctor>));
    hud_assert_true((hud::is_implicitly_copy_constructible_v<hud_test::no_explicit_cross_explicit_ctor_2, hud_test::explicit_ctor>));
    hud_assert_true((hud::is_implicitly_copy_constructible_v<hud_test::no_explicit_cross_explicit_ctor_3, hud_test::explicit_ctor>));

    // Explicit copy constructor other explicit copy ctor type
    hud_assert_false((hud::is_implicitly_copy_constructible_v<hud_test::explicit_cross_explicit_ctor, hud_test::explicit_ctor>));
    hud_assert_false((hud::is_implicitly_copy_constructible_v<hud_test::explicit_cross_explicit_ctor_2, hud_test::explicit_ctor>));
    hud_assert_false((hud::is_implicitly_copy_constructible_v<hud_test::explicit_cross_explicit_ctor_3, hud_test::explicit_ctor>));

    // Implicit copy constructor other implicit copy ctor type
    hud_assert_true((hud::is_implicitly_copy_constructible_v<hud_test::no_explicit_cross_no_explicit_ctor, hud_test::no_explicit_ctor>));
    hud_assert_true((hud::is_implicitly_copy_constructible_v<hud_test::no_explicit_cross_no_explicit_ctor_2, hud_test::no_explicit_ctor>));
    hud_assert_true((hud::is_implicitly_copy_constructible_v<hud_test::no_explicit_cross_no_explicit_ctor_3, hud_test::no_explicit_ctor>));

    // explicit copy constructor other implicit copy ctor type
    hud_assert_false((hud::is_implicitly_copy_constructible_v<hud_test::explicit_cross_implicit_ctor, hud_test::no_explicit_ctor>));
    hud_assert_false((hud::is_implicitly_copy_constructible_v<hud_test::explicit_cross_implicit_ctor_2, hud_test::no_explicit_ctor>));
    hud_assert_false((hud::is_implicitly_copy_constructible_v<hud_test::explicit_cross_implicit_ctor_3, hud_test::no_explicit_ctor>));
