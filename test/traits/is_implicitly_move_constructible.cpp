...
TEST(traits, is_implicitly_move_constructible) {
    ASSERT_FALSE((hud::is_implicitly_move_constructible_v<hud_test::explicit_ctor>));
    ASSERT_TRUE((hud::is_implicitly_move_constructible_v<hud_test::no_explicit_ctor>));
