...
TEST(traits, is_implicitly_constructible) {
    ASSERT_FALSE((hud::is_implicitly_constructible_v<explicit_ctor>));
    ASSERT_FALSE((hud::is_implicitly_constructible_v<explicit_ctor, i32>));
    ASSERT_FALSE((hud::is_implicitly_constructible_v<explicit_ctor, const explicit_ctor&>));
    ASSERT_FALSE((hud::is_implicitly_constructible_v<explicit_ctor, explicit_ctor&&>));

    ASSERT_TRUE((hud::is_implicitly_constructible_v<no_explicit_ctor>));
    ASSERT_TRUE((hud::is_implicitly_constructible_v<no_explicit_ctor, i32>));
    ASSERT_TRUE((hud::is_implicitly_constructible_v<no_explicit_ctor, const no_explicit_ctor&>));
    ASSERT_TRUE((hud::is_implicitly_constructible_v<no_explicit_ctor, no_explicit_ctor&&>));
