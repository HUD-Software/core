...
GTEST_TEST(traits, is_explicitly_constructible) {
    ...
    ASSERT_TRUE((hud::is_explicitly_constructible_v<hud_test::explicit_ctor, hud_test::explicit_ctor&&>));

    ASSERT_FALSE((hud::is_explicitly_constructible_v<hud_test::no_explicit_ctor>));
    ASSERT_FALSE((hud::is_explicitly_constructible_v<hud_test::no_explicit_ctor, i32>));
    ASSERT_FALSE((hud::is_explicitly_constructible_v<hud_test::no_explicit_ctor, const hud_test::no_explicit_ctor&>));
    ASSERT_FALSE((hud::is_explicitly_constructible_v<hud_test::no_explicit_ctor, hud_test::no_explicit_ctor&&>));
