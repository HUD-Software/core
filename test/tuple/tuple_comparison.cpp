...
GTEST_TEST(tuple, equal_operator_different_types)
{
    ...
    const auto test = []()
    {
        return std::tuple {
            tuple_type {     22, L'a', hud_test::comparable(33)}
             == hud::tuple<i32, wchar, i32> {     22, L'a',                       33},
            tuple_type {     22, L'a', hud_test::comparable(33)}
             == hud::tuple<i32, wchar, i32> {     22, L'a',                       44},
            tuple_type {     22, L'a', hud_test::comparable(33)}
             == hud::tuple<i32, char16, hud_test::comparable> {     22, u'a', hud_test::comparable(33)},
            tuple_type {     22, L'a', hud_test::comparable(33)}
             == hud::tuple<i32, char16, hud_test::comparable> {     22, u'b', hud_test::comparable(33)},
            tuple_type {     22, L'a', hud_test::comparable(33)}
             == hud::tuple<i16, wchar, hud_test::comparable> {(i16)22, L'a', hud_test::comparable(33)},
            tuple_type {     22, L'a', hud_test::comparable(33)}
             == hud::tuple<i16, wchar, hud_test::comparable> {(i16)11, L'a', hud_test::comparable(33)}
        };
    };
    ...
    const auto test = []()
    {
        return std::tuple {
            ...
            tuple_type {22, L'a', hud_test::comparable(33)}
             < hud::tuple<i32, wchar, i32> {22, L'a', 44},
            tuple_type {22, L'a', hud_test::comparable(33)}
             < hud::tuple<i32, wchar, i32> {22, L'a', 22},
            tuple_type {22, L'a', hud_test::comparable(33)}
             < hud::tuple<i32, char16, hud_test::comparable> {22, u'a', hud_test::comparable(33)},
            tuple_type {22, L'a', hud_test::comparable(33)}
             < hud::tuple<i32, char16, hud_test::comparable> {22, u'b', hud_test::comparable(33)},
            tuple_type {22, L'a', hud_test::comparable(33)}
             < hud::tuple<i32, char16, hud_test::comparable> {22, u'\0', hud_test::comparable(33)},
            tuple_type {22, L'a', hud_test::comparable(33)}
             < hud::tuple<i16, wchar, hud_test::comparable> {(i16)22, u'a', hud_test::comparable(33)},
            tuple_type {22, L'a', hud_test::comparable(33)}
             < hud::tuple<i16, wchar, hud_test::comparable> {(i16)33, u'b', hud_test::comparable(33)},
            tuple_type {22, L'a', hud_test::comparable(33)}
             < hud::tuple<i16, wchar, hud_test::comparable> {(i16)11, u'\0', hud_test::comparable(33)}
        };
    };
    ...
    const auto test = []()
    {
        return std::tuple {
            ...
            tuple_type {22, L'a', hud_test::comparable(33)}
             <= hud::tuple<i16, wchar, hud_test::comparable> {(i16)22, L'a', hud_test::comparable(33)},
            tuple_type {22, L'a', hud_test::comparable(33)}
             <= hud::tuple<i16, wchar, hud_test::comparable> {(i16)33, L'a', hud_test::comparable(33)},
            tuple_type {22, L'a', hud_test::comparable(33)}
             <= hud::tuple<i16, wchar, hud_test::comparable> {(i16)11, L'a', hud_test::comparable(33)}
        };
    };
