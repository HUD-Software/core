...
//     hud_assert_eq(hud::bits::has_value_byte(0xFFFFFFFFFFFFFFFFu, 0xFF), 0x8080808080808080u);
//     hud_assert_eq(hud::bits::has_value_byte(0xFF00FF00FF00FF00u, 0xFF), 0x8000800080008000u);
// }
...
//     hud_assert_eq(result_9, 0x8000000000000000u);
//     constexpr u64 result_10 = hud::bits::has_value_byte(0xFFFFFFFFFFFFFFFFu, 0xFF);
//     hud_assert_eq(result_10, 0x8080808080808080u);
//     constexpr u64 result_11 = hud::bits::has_value_byte(0xFF00FF00FF00FF00u, 0xFF);
//     hud_assert_eq(result_11, 0x8000800080008000u);
// }
// }