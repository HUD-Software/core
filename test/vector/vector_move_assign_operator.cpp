...
GTEST_TEST(vector, move_assign_array_of_bitwise_move_assignable_same_type_same_allocator)
{
...
GTEST_TEST(vector, move_assign_array_of_bitwise_move_assignable_same_type_different_allocator)
{
...
// vector &operator=(vector<u_type_t, u_allocator_t> &&other)
GTEST_TEST(vector, move_assign_array_of_bitwise_move_assignable_different_type_same_allocator)
{
    using type1 = i32;
    using type2 = u32;
...
// vector &operator=(vector<u_type_t, u_allocator_t> &&other)
GTEST_TEST(vector, move_assign_array_of_bitwise_move_assignable_different_type_different_allocator)
{
    using type1 = i32;
    using type2 = u32;
    // Ensure we test with different types
...
// vector &operator=(vector<u_type_t, u_allocator_t> &&other)
GTEST_TEST(vector, move_assign_array_of_non_bitwise_move_assignable_same_type_same_allocator)
{
...
// vector &operator=(vector<u_type_t, u_allocator_t> &&other)
GTEST_TEST(vector, move_assign_array_of_non_bitwise_move_assignable_same_type_different_allocator)
{
...
// vector &operator=(vector<u_type_t, u_allocator_t> &&other)
GTEST_TEST(vector, move_assign_array_of_non_bitwise_move_assignable_different_type_same_allocator)
{
...
// vector &operator=(vector<u_type_t, u_allocator_t> &&other)
GTEST_TEST(vector, move_assign_array_of_non_bitwise_move_assignable_different_type_different_allocator)
{
...
// vector &operator=(vector &&other)
GTEST_TEST(vector, move_assign_array_same_allocator_call_destructor_of_elements)
{
...
// vector &operator=(vector<u_type_t, u_allocator_t> &&other)
GTEST_TEST(vector, move_assign_array_different_allocator_call_destructor_of_elements)
{
...
// vector &operator=(vector &&other)
GTEST_TEST(vector, move_assign_array_of_bitwise_copy_assignable_to_self)
{
...
// vector &operator=(vector &&other)
GTEST_TEST(vector, move_assign_array_of_non_bitwise_copy_assignable_to_self)
{
