...
GTEST_TEST(vector, emplace_at_can_default_construct_non_trivially_default_constructible_type)
{
    ...
    // Emplace at the end of empty vector
    {
        // Reallocation
        {
            ...
            vector.emplace_at(vector.count());
    ...
    // Emplace at the middle of an vector
    {
        // Reallocation
        {
            ...
            // Emplace first element
            vector.emplace_at(vector.count() / 2u);
...
GTEST_TEST(vector, emplace_at_can_default_construct_trivially_default_constructible_type)
{
...
GTEST_TEST(vector, emplace_at_can_construct_non_trivially_constructible_type)
{
    ...
    // Emplace at the end of empty vector
    {
        // Reallocation
        {
            ...
            // Emplace first element
            vector.emplace_at(vector.count(), 1);
            ...
            // Emplace second element
            vector.emplace_at(vector.count(), 2);
    ...
    // Emplace at the middle of an vector
    {
        // Reallocation
        {
            ...
            // Emplace first element
            vector.emplace_at(vector.count() / 2u, 3);
...
GTEST_TEST(vector, emplace_at_can_construct_trivially_constructible_type)
{
    ...
    // Emplace at the end of empty vector
    {
        // Reallocation
        {
            ...
            // Emplace first element
            vector.emplace_at(vector.count(), 1u);
    ...
    // Emplace at the middle of an vector
    {
        // Reallocation
        {
            ...
            // Emplace first element
            vector.emplace_at(vector.count() / 2u, 3u);
...
GTEST_TEST(vector, emplace_at_can_copy_construct_non_bitwise_copy_constructible_type)
{
    ...
    // Emplace at the end of empty vector
    {
        // Reallocation
        {
            ...
            // Emplace first element
            vector.emplace_at(vector.count(), first_element_to_copy);
            ...
            // Emplace second element
            vector.emplace_at(vector.count(), second_element_to_copy);
        ...
        // No reallocation
        {
            ...
            // Emplace first element
            vector.emplace_at(0, first_element_to_copy);
            ...
            // Emplace second element
            vector.emplace_at(1, second_element_to_copy);
    ...
    // Emplace at the middle of an vector
    {
        // Reallocation
        {
            ...
            // Emplace first element
            vector.emplace_at(vector.count() / 2u, first_element_to_copy);
    ...
    // Emplace at the begin of an vector
    {
        // Reallocation
        {
            ...
            // Emplace second element
            vector.emplace_at(0, second_element_to_copy);
...
GTEST_TEST(vector, emplace_at_can_copy_construct_bitwise_copy_constructible_type)
{
...
GTEST_TEST(vector, emplace_at_can_move_construct_non_bitwise_move_constructible_type)
{
    ...
    // Emplace at the end of empty vector
    {
        // Reallocation
        {
            ...
            // Emplace first element
            vector.emplace_at(vector.count(), hud::move(first_element_to_move));
            ...
            // Emplace second element
            vector.emplace_at(vector.count(), hud::move(second_element_to_move));
        ...
        // No reallocation
        {
            ...
            // Emplace first element
            vector.emplace_at(0, hud::move(first_element_to_move));
            ...
            // Emplace second element
            vector.emplace_at(1, hud::move(second_element_to_move));
    ...
    // Emplace at the middle of an vector
    {
        // Reallocation
        {
            ...
            // Emplace first element
            vector.emplace_at(vector.count() / 2u, hud::move(first_element_to_move));
    ...
    // Emplace at the begin of an vector
    {
        // Reallocation
        {
            ...
            // Emplace second element
            vector.emplace_at(0, hud::move(second_element_to_move));
...
GTEST_TEST(vector, emplace_at_can_move_construct_bitwise_move_constructible_type)
{
