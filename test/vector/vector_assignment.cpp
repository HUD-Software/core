...
// vector &operator=(std::initializer_list<u_type_t>)
GTEST_TEST(vector, assign_std_initializer_list_of_bitwise_copy_assignable_same_type)
{
...
// vector &operator=(std::initializer_list<u_type_t>)
GTEST_TEST(vector, assign_std_initializer_list_of_bitwise_copy_assignable_different_type)
{
    ...
    // Test with extra
    {
        const auto test = [](std::initializer_list<destination_type> &&elements_in_assigned, const usize extra, std::initializer_list<source_type> elements_to_assign) {
            hud::vector<destination_type, hud_test::allocator_watcher<alignof(destination_type)>> assigned(elements_in_assigned, extra);
...
// vector &operator=(std::initializer_list<u_type_t>)
GTEST_TEST(vector, assign_std_initializer_list_of_non_bitwise_copy_assignable_same_type)
{
...
// vector &operator=(std::initializer_list<u_type_t>)
GTEST_TEST(vector, assign_std_initializer_list_of_non_bitwise_copy_assignable_different_type)
{
...
// vector &operator=(std::initializer_list<u_type_t>)
GTEST_TEST(vector, assign_std_initializer_list_call_destructor_of_elements)
{
    ...
    // Test with extra
    {
        const auto test = [](const usize count_in_assigned, const usize extra, const usize count_to_assigned) {
            ...
            hud::vector<hud_test::SetBoolToTrueWhenDestroyed, hud_test::allocator_watcher<alignof(hud_test::SetBoolToTrueWhenDestroyed)>> assigned(dtor_assigned_ptr_counter, count_in_assigned, extra);
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(vector, assign_std_initializer_list_of_bitwise_copy_assignable_same_type_no_extra)
{
    ...
    // Test without extra
    {
        const auto test = [](std::initializer_list<type> elements_in_assigned, std::initializer_list<type> elements_to_assign) {
            ...
            assigned.assign(elements_to_assign, 0);
    ...
    // Test with extra
    {
        const auto test = [](std::initializer_list<type> elements_in_assigned, const usize extra, std::initializer_list<type> elements_to_assign) {
            ...
            assigned.assign(elements_to_assign);
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(vector, assign_std_initializer_list_of_bitwise_copy_assignable_same_type_with_extra)
{
    ...
    // Test without extra
    {
        const auto test = [](std::initializer_list<type> elements_in_assigned, std::initializer_list<type> elements_to_assign) {
            ...
            assigned.assign(elements_to_assign, 1);
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(vector, assign_std_initializer_list_of_bitwise_copy_assignable_different_type_no_extra)
{
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(vector, assign_std_initializer_list_of_bitwise_copy_assignable_different_type_with_extra)
{
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(vector, assign_std_initializer_list_of_non_bitwise_copy_assignable_same_type_no_extra)
{
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(vector, assign_std_initializer_list_of_non_bitwise_copy_assignable_same_type_with_extra)
{
    ...
    // Test without extra
    {
        const auto test = [](std::initializer_list<type> elements_in_assigned, std::initializer_list<type> elements_to_assign) {
            ...
            assigned.assign(elements_to_assign, extra_assign);
    ...
    // Test with extra
    {
        const auto test = [](std::initializer_list<type> elements_in_assigned, const usize extra, std::initializer_list<type> elements_to_assign) {
            ...
            for (usize index = 0; index < assigned.count(); index++) {
                ...
                // Ensure we correctly call copy constructors
                if ((elements_in_assigned.size() + extra) < (elements_to_assign.size() + extra_assign)) {
                    // If we assign more element, we should have reallocate
                    if (assigned[index].copy_constructor_count() != 1u) {
                        all_copy_constructors_are_called = false;
                        break;
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(vector, assign_std_initializer_list_of_non_bitwise_copy_assignable_different_type_no_extra)
{
...
// void assign(std::initializer_list<u_type_t> list, const usize extra = 0)
GTEST_TEST(vector, assign_std_initializer_list_of_non_bitwise_copy_assignable_different_type_with_extra)
{
