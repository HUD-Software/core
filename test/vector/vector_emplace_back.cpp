...
GTEST_TEST(vector, emplace_back_can_default_construct_non_trivially_default_constructible_type)
{
    ...
    for (usize element_count = 0; element_count < 5; element_count++) {
        ...
        for (usize index = 0; index < element_count; index++) {
            ...
            hud_assert_eq(vector.emplace_back(), index);
...
GTEST_TEST(vector, emplace_back_can_default_construct_trivially_default_constructible_type)
{
...
GTEST_TEST(vector, emplace_back_can_construct_non_trivially_constructible_type)
{
    ...
    for (usize element_count = 0; element_count < 5; element_count++) {
        ...
        for (usize index = 0; index < element_count; index++) {
            // Emplace default construct element
            hud_assert_eq(vector.emplace_back(static_cast<i32>(index)), index);
            hud_assert_ne(vector.data(), nullptr);
            hud_assert_eq(vector.count(), index + 1);
            hud_assert_eq(vector.max_count(), index + 1);
...
GTEST_TEST(vector, emplace_back_can_construct_trivially_constructible_type)
{
    ...
    for (usize element_count = 0; element_count < 5; element_count++) {
        ...
        for (usize index = 0; index < element_count; index++) {
            // Emplace default construct element
            hud_assert_eq(vector.emplace_back(index), index);
            hud_assert_ne(vector.data(), nullptr);
            hud_assert_eq(vector.count(), index + 1);
            hud_assert_eq(vector.max_count(), index + 1);
...
GTEST_TEST(vector, emplace_back_can_copy_construct_non_bitwise_copy_constructible_type)
{
    ...
    for (usize element_count = 0; element_count < 5; element_count++) {
        ...
        for (usize index = 0; index < element_count; index++) {
            ...
            hud_assert_eq(vector.emplace_back(element_to_copy), index);
            hud_assert_ne(vector.data(), nullptr);
            hud_assert_eq(vector.count(), index + 1);
            hud_assert_eq(vector.max_count(), index + 1);
            hud_assert_eq(static_cast<usize>(vector[index].id()), index);
...
GTEST_TEST(vector, emplace_back_can_copy_construct_bitwise_copy_constructible_type)
{
...
GTEST_TEST(vector, emplace_back_can_move_construct_non_bitwise_move_constructible_type)
{
    ...
    for (usize element_count = 0; element_count < 5; element_count++) {
        ...
        for (usize index = 0; index < element_count; index++) {
            ...
            // Emplace copy construct element
            hud_assert_eq(vector.emplace_back(hud::move(element_to_move)), index);
            hud_assert_ne(vector.data(), nullptr);
            hud_assert_eq(vector.count(), index + 1);
            hud_assert_eq(vector.max_count(), index + 1);
            hud_assert_eq(static_cast<usize>(vector[index].id()), index);
...
GTEST_TEST(vector, emplace_back_can_move_construct_bitwise_move_constructible_type)
{
    ...
    for (usize element_count = 0; element_count < 5; element_count++) {
        ...
        for (usize index = 0; index < element_count; index++) {
            // Emplace copy construct element
            hud_assert_eq(vector.emplace_back(type(index)), index);
            hud_assert_ne(vector.data(), nullptr);
            hud_assert_eq(vector.count(), index + 1);
            hud_assert_eq(vector.max_count(), index + 1);
            hud_assert_eq(vector[index], type(index));
