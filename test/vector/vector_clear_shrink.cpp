...
GTEST_TEST(vector, clear_shrink_destroy_but_keep_allocated_memory_with_non_trivial_type)
{
...
GTEST_TEST(vector, clear_shrink_destroy_but_keep_allocated_memory_with_trivial_type)
{
...
GTEST_TEST(vector, clear_shrink_empty_do_nothing_with_non_trivial_type)
{
...
GTEST_TEST(vector, clear_shrink_empty_do_nothing_with_trivial_type)
{
