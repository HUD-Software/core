...
GTEST_TEST(shared_pointer_safe, copy_assignement_same_type)
{
...
GTEST_TEST(shared_pointer_safe, copy_assignement_different_type)
{
    const auto test = [](i32 id)
    {
        i32 dtor_count = 0;
...
GTEST_TEST(shared_pointer_safe, copy_assignement_an_empty_same_type)
{
    const auto test = [](i32 id)
    {
        i32 dtor_count = 0;
        ...
        const hud::shared_pointer<hud_test::non_bitwise_type, hud::thread_safety_e::safe> empty;
        shared_ptr = empty;
        return std::tuple {
...
GTEST_TEST(shared_pointer_safe, copy_assignement_nullptr)
{
    const auto test = [](i32 id)
    {
        i32 dtor_count = 0;
...
GTEST_TEST(shared_pointer_safe, move_assignement_same_type)
{
    const auto test = [](i32 id)
    {
        i32 dtor_count = 0;
        hud_test::non_bitwise_type *type = new hud_test::non_bitwise_type(id, &dtor_count);
        hud::shared_pointer<hud_test::non_bitwise_type, hud::thread_safety_e::safe> shared_ptr_to_copy(type);
        hud::shared_pointer<hud_test::non_bitwise_type, hud::thread_safety_e::safe> shared_ptr;
    ...
    // Non constant
    {
        ...
        hud_assert_eq(std::get<3>(result), 1u);
        hud_assert_eq(std::get<4>(result), 123);
...
GTEST_TEST(shared_pointer_safe, move_assignement_different_type)
{
    const auto test = [](i32 id)
    {
        i32 dtor_count = 0;
        hud_test::non_bitwise_type2 *type = new hud_test::non_bitwise_type2(id, &dtor_count);
        hud::shared_pointer<hud_test::non_bitwise_type2, hud::thread_safety_e::safe> shared_ptr_to_copy(type);
        hud::shared_pointer<hud_test::non_bitwise_type, hud::thread_safety_e::safe> shared_ptr;
        shared_ptr = hud::move(shared_ptr_to_copy);
        return std::tuple {
            shared_ptr_to_copy.pointer() == nullptr,
...
GTEST_TEST(shared_pointer_safe, move_assignement_an_empty_same_type)
{
    const auto test = [](i32 id)
    {
        i32 dtor_count = 0;
...
GTEST_TEST(shared_pointer_safe, move_assignement_nullptr)
{
    const auto test = [](i32 id)
    {
        i32 dtor_count = 0;
...
GTEST_TEST(shared_pointer_safe, copy_assignement_same_shared_pointer)
{
    const auto test = [](i32 id)
    {
        i32 dtor_count = 0;
...
GTEST_TEST(shared_pointer_safe, move_assignement_same_shared_pointer)
{
    const auto test = [](i32 id)
    {
        i32 dtor_count = 0;
