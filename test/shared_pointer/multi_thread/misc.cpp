...
TEST(SharedPointer_safe, single_thread_pointer_return_object) {


    const auto test = []() {
        auto ptr = new hud::test::NonBitwiseType(15, nullptr);
        SharedPointer<hud::test::NonBitwiseType, EThreadSafety::safe> shared_ptr(ptr);
        return std::tuple{
...
TEST(SharedPointer_safe, single_thread_empty_pointer_return_nullptr) {
...
TEST(SharedPointer_safe, single_thread_is_owning) {


    const auto test = []() {
        SharedPointer<hud::test::NonBitwiseType, EThreadSafety::safe> shared_ptr(new hud::test::NonBitwiseType(15, nullptr));
        SharedPointer<hud::test::NonBitwiseType, EThreadSafety::safe> empty_shared_ptr;
        return std::tuple{
...
TEST(SharedPointer_safe, cast_to_bool) {
...
TEST(SharedPointer_safe, operator_dereference) {
...
TEST(SharedPointer_safe, operator_arrow) {
...
TEST(SharedPointer_safe, reset_to_empty) {
...
TEST(SharedPointer_safe, reset_to_nullptr) {
...
TEST(SharedPointer_safe, reset_to_same_type) {
...
TEST(SharedPointer_safe, reset_to_different_type) {
    ...
    const auto test = []() {
        ...
        auto ptr = new hud::test::NonBitwiseType(15, &dtor_count);
        SharedPointer<const hud::test::NonBitwiseType, EThreadSafety::safe> shared_ptr(ptr);
        const bool is_pointer_correct = shared_ptr.pointer() == ptr;

        SharedPointer<const hud::test::NonBitwiseType, EThreadSafety::safe> empty_shared_ptr;
        const bool is_pointer_empty_correct = empty_shared_ptr.pointer() == nullptr;
...
TEST(SharedPointer_safe, reset_to_empty_should_not_delete_if_other_reference_exists) {
    ...
    const auto test = []() {
        ...
        SharedPointer<hud::test::NonBitwiseType, EThreadSafety::safe> shared_ptr(ptr);
        const bool is_pointer_correct = shared_ptr.pointer() == ptr;
        SharedPointer<hud::test::NonBitwiseType, EThreadSafety::safe> second_shared_ptr(shared_ptr);
...
TEST(SharedPointer_safe, reset_to_other_pointer_should_not_delete_if_other_reference_exists) {
...
TEST(SharedPointer_safe, make_shared) {


    const auto test = []() {
        const auto shared_ptr = make_shared<i32, EThreadSafety::safe>(123);
        i32 dtor_count = 0;
        const auto shared_ptr_2 = make_shared<hud::test::NonBitwiseType, EThreadSafety::safe>(123, &dtor_count);
...
TEST(SharedPointer_safe, hash) {

    const auto test = []() {
        SharedPointer<i32, EThreadSafety::safe> ptr(new i32(123));
