...
TEST(shared_pointer_safe, single_thread_pointer_return_object) {
...
TEST(shared_pointer_safe, single_thread_empty_pointer_return_nullptr) {
...
TEST(shared_pointer_safe, single_thread_is_owning) {
...
TEST(shared_pointer_safe, cast_to_bool) {
...
TEST(shared_pointer_safe, operator_dereference) {
...
TEST(shared_pointer_safe, operator_arrow) {
...
TEST(shared_pointer_safe, reset_to_empty) {
...
TEST(shared_pointer_safe, reset_to_nullptr) {
...
TEST(shared_pointer_safe, reset_to_same_type) {
...
TEST(shared_pointer_safe, reset_to_different_type) {
...
TEST(shared_pointer_safe, reset_to_empty_should_not_delete_if_other_reference_exists) {
...
TEST(shared_pointer_safe, reset_to_other_pointer_should_not_delete_if_other_reference_exists) {
...
TEST(shared_pointer_safe, make_shared) {
