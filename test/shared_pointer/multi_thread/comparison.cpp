...
TEST(shared_pointer_safe, equal_operator) {
...
TEST(shared_pointer_safe, not_equal_operator) {
...
TEST(shared_pointer_safe, less_operator) {
...
TEST(shared_pointer_safe, less_equal_operator) {
...
TEST(shared_pointer_safe, greater_operator) {
...
TEST(shared_pointer_safe, greater_equal_operator) {
