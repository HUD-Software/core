...
TEST(SharedPointer_not_safe, default_constructor) {
...
TEST(SharedPointer_not_safe, param_constructor_nullptr) {


    const auto test = []()
    {
        SharedPointer<hud::test::NonBitwiseType> shared_ptr(nullptr);
        return std::tuple{
            shared_ptr.pointer() == nullptr,
            shared_ptr.shared_count()
        };
...
TEST(SharedPointer_not_safe, param_constructor_same_type) {
...
TEST(SharedPointer_not_safe, param_constructor_different_type) {
...
TEST(SharedPointer_not_safe, copy_constructor_same_type) {
    ...
    const auto test = [](i32 id) {
        ...
        SharedPointer<hud::test::NonBitwiseType> shared_ptr(shared_ptr_to_copy);
...
TEST(SharedPointer_not_safe, copy_constructor_different_type) {
...
TEST(SharedPointer_not_safe, move_constructor_same_type) {


    const auto test = [](i32 id) {
        i32 dtor_count = 0;
        hud::test::NonBitwiseType* type = new hud::test::NonBitwiseType(id, &dtor_count);
        SharedPointer<hud::test::NonBitwiseType> shared_ptr_to_move(type);
        SharedPointer<hud::test::NonBitwiseType> shared_ptr(hud::move(shared_ptr_to_move));
...
TEST(SharedPointer_not_safe, move_constructor_different_type) {


    const auto test = [](i32 id) {
        i32 dtor_count = 0;
        hud::test::NonBitwiseType2* type = new hud::test::NonBitwiseType2(id, &dtor_count);
        SharedPointer<hud::test::NonBitwiseType2> shared_ptr_to_move(type);
        SharedPointer<hud::test::NonBitwiseType> shared_ptr(hud::move(shared_ptr_to_move));
