...
TEST(SharedPointer_not_safe, equal_operator) {


    const auto test = []() {
        SharedPointer<i32> empty;
        SharedPointer<i32> p(new i32(1));
        SharedPointer<i32> p2(p);
        SharedPointer<i32> p3(new i32(3));
...
TEST(SharedPointer_not_safe, not_equal_operator) {
...
TEST(SharedPointer_not_safe, less_operator) {
    ...
    const auto test = []() {
        ...
        SharedPointer<i32> empty;
        SharedPointer<i32> p1(ptr1);
        SharedPointer<i32> p2(ptr2);
...
TEST(SharedPointer_not_safe, less_equal_operator) {
...
TEST(SharedPointer_not_safe, greater_operator) {
...
TEST(SharedPointer_not_safe, greater_equal_operator) {
