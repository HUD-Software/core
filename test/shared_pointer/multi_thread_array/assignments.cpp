...
TEST(shared_pointer_array_safe, copy_assignement_same_type) {
...
TEST(shared_pointer_array_safe, copy_assignement_different_type) {
...
TEST(shared_pointer_array_safe, copy_assignement_an_empty_same_type) {
...
TEST(shared_pointer_array_safe, copy_assignement_nullptr) {
...
TEST(shared_pointer_array_safe, move_assignement_same_type) {
...
TEST(shared_pointer_array_safe, move_assignement_different_type) {
...
TEST(shared_pointer_array_safe, move_assignement_an_empty_same_type) {
...
TEST(shared_pointer_array_safe, move_assignement_nullptr) {
