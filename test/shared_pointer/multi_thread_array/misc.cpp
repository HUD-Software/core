...
TEST(SharedPointer_array_safe, single_thread_pointer_return_object) {
...
TEST(SharedPointer_array_safe, single_thread_empty_pointer_return_nullptr) {
...
TEST(SharedPointer_array_safe, single_thread_is_owning) {


    const auto test = []() {
        SharedPointer<hud::test::NonBitwiseType[2], EThreadSafety::safe> shared_ptr(new hud::test::NonBitwiseType[2]{ { 1, nullptr }, {2, nullptr} });
        SharedPointer<hud::test::NonBitwiseType[2], EThreadSafety::safe> empty_shared_ptr;
        return std::tuple{
...
TEST(SharedPointer_array_safe, cast_to_bool) {
...
TEST(SharedPointer_array_safe, operator_dereference) {
...
TEST(SharedPointer_array_safe, operator_arrow) {
...
TEST(SharedPointer_array_safe, reset_to_empty) {
...
TEST(SharedPointer_array_safe, reset_to_nullptr) {
...
TEST(SharedPointer_array_safe, reset_to_same_type) {
...
TEST(SharedPointer_array_safe, reset_to_different_type) {
    ...
    const auto test = []() {
        ...
        SharedPointer<const hud::test::NonBitwiseType[2], EThreadSafety::safe> shared_ptr(ptr);
        const bool is_pointer_correct = shared_ptr.pointer() == ptr;

        SharedPointer<const hud::test::NonBitwiseType[2], EThreadSafety::safe> empty_shared_ptr;
        const bool is_pointer_empty_correct = empty_shared_ptr.pointer() == nullptr;
...
TEST(SharedPointer_array_safe, reset_to_empty_should_not_delete_if_other_reference_exists) {
    ...
    const auto test = []() {
        ...
        SharedPointer<hud::test::NonBitwiseType[2], EThreadSafety::safe> shared_ptr(ptr);
        const bool is_pointer_correct = shared_ptr.pointer() == ptr;
        SharedPointer<hud::test::NonBitwiseType[2], EThreadSafety::safe> second_shared_ptr(shared_ptr);
...
TEST(SharedPointer_array_safe, reset_to_other_pointer_should_not_delete_if_other_reference_exists) {
...
TEST(SharedPointer_array_safe, make_shared) {


    const auto test = []() {
        const auto shared_ptr = make_shared<i32[], EThreadSafety::safe>(2);
        hud::memory::construct_at(&shared_ptr[0], 1);
        hud::memory::construct_at(&shared_ptr[1], 2);
        i32 dtor_count[2] = { 0,0 };
        const auto shared_ptr_2 = make_shared<hud::test::NonBitwiseType[], EThreadSafety::safe>(2);
...
TEST(SharedPointer_array_safe, hash) {

    const auto test = []() {
        SharedPointer<i32[2], EThreadSafety::safe> ptr(new i32[2]{ 1,2 });
