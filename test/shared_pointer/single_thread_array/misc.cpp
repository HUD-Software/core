...
TEST(shared_pointer_array_not_safe, single_thread_pointer_return_object) {
...
TEST(shared_pointer_array_not_safe, single_thread_empty_pointer_return_nullptr) {
...
TEST(shared_pointer_array_not_safe, single_thread_is_owning) {
...
TEST(shared_pointer_array_not_safe, cast_to_bool) {
...
TEST(shared_pointer_array_not_safe, operator_dereference) {
...
TEST(shared_pointer_array_not_safe, operator_arrow) {
...
TEST(shared_pointer_array_not_safe, reset_to_empty) {
...
TEST(shared_pointer_array_not_safe, reset_to_nullptr) {
...
TEST(shared_pointer_array_not_safe, reset_to_same_type) {
...
TEST(shared_pointer_array_not_safe, reset_to_different_type) {
    ...
    const auto test = []() {
        ...
        hud::shared_pointer<const hud_test::non_bitwise_type[2]> empty_shared_ptr;
        const bool is_pointer_empty_correct = empty_shared_ptr.pointer() == nullptr;
...
TEST(shared_pointer_array_not_safe, reset_to_empty_should_not_delete_if_other_reference_exists) {
...
TEST(shared_pointer_array_not_safe, reset_to_other_pointer_should_not_delete_if_other_reference_exists) {
...
TEST(shared_pointer_array_not_safe, make_shared) {
...
TEST(shared_pointer_array_not_safe, hash) {
