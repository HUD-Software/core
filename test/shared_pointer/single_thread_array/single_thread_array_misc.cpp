...
GTEST_TEST(shared_pointer_array_not_safe, less_or_equal_size_as_std_unique_ptr)
{
...
GTEST_TEST(shared_pointer_array_not_safe, hash_32)
{
...
GTEST_TEST(shared_pointer_array_not_safe, hash_64)
{
