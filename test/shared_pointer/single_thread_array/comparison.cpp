...
TEST(shared_pointer_array_not_safe, equal_operator) {
...
TEST(shared_pointer_array_not_safe, not_equal_operator) {
...
TEST(shared_pointer_array_not_safe, less_operator) {
...
TEST(shared_pointer_array_not_safe, less_equal_operator) {
...
TEST(shared_pointer_array_not_safe, greater_operator) {
...
TEST(shared_pointer_array_not_safe, greater_equal_operator) {
