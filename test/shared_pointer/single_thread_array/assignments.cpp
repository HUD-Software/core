...
TEST(SharedPointer_array_not_safe, copy_assignement_same_type) {
...
TEST(SharedPointer_array_not_safe, copy_assignement_different_type) {
...
TEST(SharedPointer_array_not_safe, copy_assignement_an_empty_same_type) {
    ...
    const auto test = []() {
        ...
        const SharedPointer<hud::test::NonBitwiseType[2]> empty;
        shared_ptr = empty;
...
TEST(SharedPointer_array_not_safe, copy_assignement_nullptr) {
...
TEST(SharedPointer_array_not_safe, move_assignement_same_type) {
...
TEST(SharedPointer_array_not_safe, move_assignement_different_type) {
    ...
    const auto test = []() {
        ...
        hud::test::NonBitwiseType* type = new hud::test::NonBitwiseType[2]{ {1, &dtor_count[0]},{2, &dtor_count[1]} };
        SharedPointer<hud::test::NonBitwiseType[2]> shared_ptr_to_move(type);
        SharedPointer<const hud::test::NonBitwiseType[2]> shared_ptr;
        shared_ptr = hud::move(shared_ptr_to_move);
...
TEST(SharedPointer_array_not_safe, move_assignement_an_empty_same_type) {
    ...
    const auto test = []() {
        ...
        hud::test::NonBitwiseType* type = new hud::test::NonBitwiseType[2]{ {1, &dtor_count[0]},{2, &dtor_count[1]} };
        SharedPointer<hud::test::NonBitwiseType[2]> shared_ptr(type);
        SharedPointer<hud::test::NonBitwiseType[2]> empty;
...
TEST(SharedPointer_array_not_safe, move_assignement_nullptr) {
