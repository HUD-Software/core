...
TEST(CString, format_vargs) {
    ...
    ansichar buffer[256];
    i32 character_count = hud::test::call_format_vargs(buffer, 256, fmt, "World", L"Hammer");
    ...
    character_count = hud::test::call_format_vargs(wide_buffer, 256, wide_fmt, L"World", L"Hammer");
