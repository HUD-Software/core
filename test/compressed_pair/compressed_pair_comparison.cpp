...
GTEST_TEST(compressed_pair, operator_equal)
{

    const auto test = [](hud::compressed_pair<i32, wchar> r, hud::compressed_pair<i32, wchar> l)
    {
        return r == l;
    };
...
GTEST_TEST(compressed_pair, operator_not_equal)
{
...
GTEST_TEST(compressed_pair, operator_less)
{
...
GTEST_TEST(compressed_pair, operator_less_equal)
{
...
GTEST_TEST(compressed_pair, operator_greater)
{
...
GTEST_TEST(compressed_pair, operator_greater_equal)
{
