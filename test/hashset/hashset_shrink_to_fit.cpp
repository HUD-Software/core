...
GTEST_TEST(hashset, shrink_to_fit_on_empty_do_nothing)
{
...
GTEST_TEST(hashset, shrink_to_fit_empty_but_reserved_is_ok)
{
    using key_type = hud_test::non_bitwise_type;
    using hashset_type = hud::hashset<key_type>;
...
GTEST_TEST(hashset, shrink_to_fit_non_empty_and_reserved_is_ok)
{
    using key_type = hud_test::non_bitwise_type;
    using hashset_type = hud::hashset<key_type>;
...
GTEST_TEST(hashset, shrink_to_fit_non_empty_is_ok)
{
    using key_type = hud_test::non_bitwise_type;
    using hashset_type = hud::hashset<key_type>;
