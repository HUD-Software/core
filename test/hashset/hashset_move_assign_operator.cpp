...
GTEST_TEST(hashset, move_assign_hashset_of_bitwise_move_constructible_same_type_same_allocator)
{
    ...
    // Test without extra
    {
        const auto test = [](std::initializer_list<key_type> elements_in_assigned, std::initializer_list<key_type> elements_to_assign)
        {
            ...
            using ToAssignType = hud::hashset<key_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType>;
    ...
    // Test with extra
    {
        const auto test = [](std::initializer_list<key_type> elements_in_assigned, usize extra_assigned, std::initializer_list<key_type> elements_to_assign, usize extra_to_assign)
        {
            using AllocatorType = hud_test::allocator_watcher<1>;
            using AssignedType = hud::hashset<key_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType>;
            using ToAssignType = hud::hashset<key_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType>;
...
GTEST_TEST(hashset, move_assign_hashset_of_bitwise_move_constructible_same_type_different_allocator)
{
    ...
    // Test without extra
    {
        const auto test = [](std::initializer_list<key_type> elements_in_assigned, std::initializer_list<key_type> elements_to_assign)
        {
            ...
            using AssignedType = hud::hashset<key_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType>;
            using ToAssignType = hud::hashset<key_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType2>;
            AssignedType assigned(elements_in_assigned);
            ToAssignType to_assign(elements_to_assign);
...
GTEST_TEST(hashset, move_assign_hashset_of_bitwise_move_constructible_different_type_same_allocator)
{
    ...
    // Test without extra
    {
        const auto test = [](std::initializer_list<key_type> elements_in_assigned, std::initializer_list<key_type_2> elements_to_assign)
        {
            using AllocatorType = hud_test::allocator_watcher<1>;
            using AssignedType = hud::hashset<key_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType>;
            using ToAssignType = hud::hashset<key_type_2, hud::hash_64<key_type_2>, hud::equal<key_type_2>, AllocatorType>;
            AssignedType assigned(elements_in_assigned);
            ToAssignType to_assign(elements_to_assign);
...
GTEST_TEST(hashset, move_assign_hashset_of_bitwise_move_constructible_different_type_different_allocator)
{
    ...
    // Test without extra
    {
        const auto test = [](std::initializer_list<key_type> elements_in_assigned, std::initializer_list<key_type_2> elements_to_assign)
        {
            ...
            using AllocatorType2 = hud_test::allocator_watcher_2<1>;
            using AssignedType = hud::hashset<key_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType>;
            using ToAssignType = hud::hashset<key_type_2, hud::hash_64<key_type_2>, hud::equal<key_type_2>, AllocatorType2>;
            AssignedType assigned(elements_in_assigned);
            ToAssignType to_assign(elements_to_assign);
...
GTEST_TEST(hashset, move_assign_hashset_of_non_bitwise_move_constructible_different_type_different_allocator)
{
    ...
    // Test without extra
    {
        const auto test = [](std::initializer_list<key_type> elements_in_assigned, std::initializer_list<key_type_2> elements_to_assign)
        {
            ...
            using AllocatorType2 = hud_test::allocator_watcher_2<1>;
            using AssignedType = hud::hashset<key_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType>;
            using ToAssignType = hud::hashset<key_type_2, hud::hash_64<key_type>, hud::equal<key_type_2>, AllocatorType2>;
            AssignedType assigned(elements_in_assigned);
            ToAssignType to_assign(elements_to_assign);
...
GTEST_TEST(hashset, move_assign_hashset_same_allocator_call_destructor_of_elements)
{
    ...
    // Test without extra
    {
        const auto test = [](const usize count_in_assigned, const usize count_to_assigned)
        {
            ...
            {
                assigned.add({i, dtor_assigned_key_counter + i});
            }
...
GTEST_TEST(array, move_assign_hashset_of_bitwise_move_assignable_to_self)
{
    ...
    // Test without extra
    {
        const auto test = [](std::initializer_list<key_type> elements_in_assigned)
        {
            using AllocatorType = hud_test::allocator_watcher<1>;
            using AssignedType = hud::hashset<key_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType>;
            AssignedType assigned(elements_in_assigned);
    ...
    // Test with extra
    {
        const auto test = [](std::initializer_list<key_type> elements_in_assigned, usize extra_assigned)
        {
            using AllocatorType = hud_test::allocator_watcher<1>;
            using AssignedType = hud::hashset<key_type, hud::hash_64<key_type>, hud::equal<key_type>, AllocatorType>;
            AssignedType assigned(elements_in_assigned, extra_assigned);
