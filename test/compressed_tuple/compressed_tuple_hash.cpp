...
GTEST_TEST(compressed_tuple, hash_empty_tuple)
{
    const auto test = []()
    {
...
GTEST_TEST(compressed_tuple, hash_tuple)
{
    const auto test = []()
    {
        using TupleType = hud::compressed_tuple<i32, hud_test::non_bitwise_type, const char *>;
